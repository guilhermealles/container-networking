...
** Executing tests
After creating the cluster, logging into the login container, and configuring the MPI hosts file (described [[mpi-hosts-issue][here]]), we can execute the benchmark:
#+BEGIN_SRC sh
